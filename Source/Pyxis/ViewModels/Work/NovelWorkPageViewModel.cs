...
namespace Pyxis.ViewModels.Work
{
    public class NovelWorkPageViewModel : ViewModel
    {
        ...
        public NovelWorkPageViewModel(IAccountService accountService, INavigationService navigationService)
        {
        ...
        {
            NavigationService.Navigate("Error.LoginRequired", "Work.NovelWork");
        }
    }
}