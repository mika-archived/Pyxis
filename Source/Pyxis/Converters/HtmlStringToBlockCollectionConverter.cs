...
namespace Pyxis.Converters
{
    internal class HtmlStringToBlockCollectionConverter : DependencyObject, IValueConverter
    {
        ...
        private Inline GenerateStrikethrough(HtmlNode node)
        {
            var strikethrough = new Span {TextDecorations = TextDecorations.Strikethrough};
            AddChildren(strikethrough, node);
