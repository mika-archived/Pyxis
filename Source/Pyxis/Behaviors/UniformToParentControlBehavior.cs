...
{
    public class UniformToParentControlBehavior : Behavior<FrameworkElement>
    {
        public static readonly DependencyProperty TargetProperty =
            DependencyProperty.Register(nameof(Target), typeof(FrameworkElement), typeof(UniformToParentControlBehavior), new PropertyMetadata(null, PropertyChangedCallback));
        ...
        {
            ((FrameworkElement) e.NewValue).SizeChanged += ((UniformToParentControlBehavior) sender).ElementOnSizeChanged;
        }
