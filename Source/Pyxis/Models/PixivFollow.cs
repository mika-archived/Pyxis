...
namespace Pyxis.Models
{
    internal class PixivFollow : ISupportIncrementalLoading
    {
        ...
        public PixivFollow(string userId, RestrictType restrict, PixivClient pixivClient, IQueryCacheService queryCacheService)
        {
        ...
        {
            var users = await _pixivClient.User.FollowingAsync(_userId, Restrict.Public, offset: _offset);
